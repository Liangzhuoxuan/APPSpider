...
class XiTongZhiJIaSpider(ParseComponent):
    def __init__(self, keyword):
        super(XiTongZhiJIaSpider, self).__init__("", keyword)
        # self.quote_keyword = quote(keyword, encoding="GBK")
        self.url = "http://serach.xitongzhijia.net/cse/search?q={}&s=8474727115075543611&nsid=5".format(self.quote_keyword)
        self.n_page = 2
        self.name = "XP系统之家"
    ...
    def get_app_list_elements(self, url) -> list:
        ...
        lis = selector.xpath("//div[@id='center']/div[@id='results']//div[@class='result f s0']")
        return lis
    ...
    def get_app_intro(self, inner_response):
        selector = etree.HTML(inner_response)
        app_intro = selector.xpath("string(//div[@class='wrap auto']/div[@class='s-soft-art fix']/div[@class='art-main col-l-w']/div[@class='J_tab_cont'][1]//div[@class='m-art-cont'])")
...
if __name__ == '__main__':
    lvse_spider = XiTongZhiJIaSpider(keyword="支付")
    lvse_spider.parse()
