...
class XiXiSpider(ParseComponentAjax):
    def __init__(self, keyword):
        super(XiXiSpider, self).__init__("", keyword)
        self.url = "http://so.cr173.com/ajax.asp?action=28&num=20&urlclass=search&locationclass=search&typeclass=0&stype=az&o=rank&p=1&keyword={}".format(
            quote(keyword))
        self.n_page = 2
        self.name = "西西软件园"
...
if __name__ == '__main__':
    itmaopu_spider = XiXiSpider(keyword="金太阳")
